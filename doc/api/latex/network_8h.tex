...
\index{network.h@{network.h}!luau_net_downloadUpdate@{luau\_\-net\_\-downloadUpdate}}
\index{luau_net_downloadUpdate@{luau\_\-net\_\-downloadUpdate}!network.h@{network.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}gboolean luau\_\-net\_\-download\-Update (const {\bf AProg\-Info} $\ast$ {\em info}, const {\bf AUpdate} $\ast$ {\em update}, {\bf APkg\-Type} {\em pkg\-Type}, const char $\ast$ {\em download\-To}, GError $\ast$$\ast$ {\em err})}\label{network_8h_a1}
...
Referenced by luau\_\-download\-Update().\index{network.h@{network.h}!luau_net_queryServer@{luau\_\-net\_\-queryServer}}
\index{luau_net_queryServer@{luau\_\-net\_\-queryServer}!network.h@{network.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf GContainer}$\ast$ luau\_\-net\_\-query\-Server (const {\bf AProg\-Info} $\ast$ {\em info}, GError $\ast$$\ast$ {\em err})}\label{network_8h_a0}
